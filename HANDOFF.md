...
| 公众人物回测 | `tools/backtest_figures.py`（round 15 扩至 45 人 × 105 事件）：排盘层年柱（立春口径）45/45 ✅；六术方向回测含二项检验与自动判读——zhouyi 显著偏正（近灌水）、ziwei 82% 显著但低于事件正向占比、liuyao 41% 观察名单、bazi/meihua/qimen 与硬币无异；报告落 docs/回测报告-公众人物.md |
